...
import showgo.feature.GeneralParser;
import showgo.feature.StueckParser;
...
public class TestShowGO {
	...
	public static void main(String[] args) {
		...
		Person moritz = new Person("Moritz", "26.08.1983", "m",
				"Hauptstraße 123");
		//Ungültig
		Person fritz = new Person("peter von der uckermark > fritz der kleine //---*-", "30.02.2011", "g", ""); // TODO: Gültigkeitsprüfung hinzufügen
		...
		StueckParser bla = new StueckParser();
		bla.parsen(blub.lesen());
		
		Regieanweisung regie01 = new Regieanweisung("Ein offener Platz. Blitz und Donner. Drei Hexen treten auf");
		...
		System.out.println(gp.parsen("<!--a-->1<!--/a--><!--a-->2<!--/a--><!--a-->3<!--/a-->!", "a"));
